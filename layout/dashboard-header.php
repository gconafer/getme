...
<head>
    ...
    <body>
        ...
        <header id="header-alt">
            <a href="<?=ABS_URL?>/home" class="header-alt__trigger hidden-lg" data-rmd-action="block-open" data-rmd-target="#main__sidebar">
            ...
            <ul class="header-alt__menu">
                <li class="header-alt__profile dropdown">
                    ...
                    <ul class="dropdown-menu pull-right">
                        <li><a href="<?=ABS_URL?>/changepassword.php">Change Password</a></li>
