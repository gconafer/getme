    ...
    $(document).ready(function() {         
        ...
        $(document).on("submit", "form#changePasswordF", function() {
            ...
            if(!old_password) {
                ...
                $.post(abs_url+"/controller/setting_controller.php", {flowtype:flowtype, old_password:old_password, new_password:new_password, c_password:c_password},function(data) {
